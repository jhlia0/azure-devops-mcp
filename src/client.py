...
class AzureDevOpsClient:
    ...
    async def _make_request(self, endpoint: str, params: Optional[Dict[str, Any]] = None, project: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def get_work_items(self, ids: List[int], project: Optional[str] = None) -> List[WorkItem]:
    ...
    async def _get_work_items_batch(self, ids: List[int], project: Optional[str] = None) -> List[WorkItem]:
    ...
    async def get_work_items_by_wiql(self, wiql: str, project: Optional[str] = None) -> List[WorkItem]:
    ...
    async def get_work_item_links_by_wiql(self, wiql: str, project: Optional[str] = None) -> List[WorkItemLink]:
        ...
        for relation in work_item_relations:
            if relation.get("rel") and relation.get("source") and relation.get("target"):
                link = WorkItemLink(
    ...
    async def execute_wiql(self, wiql: str, project: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def get_backlog_items(self, team_name: Optional[str] = None, project: Optional[str] = None) -> List[BacklogItem]:
